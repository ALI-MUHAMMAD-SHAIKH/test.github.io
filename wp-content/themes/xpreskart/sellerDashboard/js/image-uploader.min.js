!function (e) {
 e.fn.imageUploader = function (t) {
  let n,
          i = {
           preloaded: [], imagesInputName: "galimg", preloadedInputName: "preloaded", label: "Drag & Drop images here or click to browse", extensions: [".jpg", ".jpeg", ".png", ".gif", ".svg"], mimes: ["image/jpeg", "image/png", "image/gif", "image/svg+xml"], maxSize: void 0, maxFiles: void 0
          }
  ,
          a = this,
          s = new DataTransfer;
